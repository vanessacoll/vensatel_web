<nav class="navbar navbar-standard navbar-expand-lg fixed-top navbar-light" data-navbar-darken-on-scroll="data-navbar-darken-on-scroll" style="background-image: none; background-color: rgb(11, 23, 39); transition: none 0s ease 0s;">
    <div class="container"><a class="navbar-brand" href="/"><img src="template/images/logovensatelblanco.png" alt="" class="logo-light" width="180" height="30"></a><button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarStandard" aria-controls="navbarStandard" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
              ...
              <div class="card shadow-none navbar-card-login">
                <div class="card-body fs--1 p-4 fw-normal">
                  ...
                  <form method="POST" action="{{ route('login') }}">
                        @csrf
                    <div class="mb-3"><input class="form-control" name="email" type="email" required="" placeholder="Email" /></div>
                    <div class="mb-3"><input class="form-control" name="password" type="password" required="" placeholder="Password" /></div>
                    <div class="row flex-between-center">
                      <div class="col-auto">
                        <div class="form-check mb-0"><input class="form-check-input" type="checkbox" id="modal-checkbox" /><label class="form-check-label mb-0" for="modal-checkbox">Recuerdame</label></div>
                      </div>
                      <div class="col-auto"><a class="fs--1" href="../pages/authentication/simple/forgot-password.html">Olvidaste tu contarseña?</a></div>
                    </div>
                    <div class="mb-3"><button class="btn btn-primary d-block w-100 mt-3" type="submit" name="submit">Iniciar session</button></div>
                  </form>
